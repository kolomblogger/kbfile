 ...
 * Templates: <div id="table-outer"><table border="0"><tr><td><label>Urutkan daftar berdasarkan:</label></td><td><select id="orderFeedBy"><option value="published" selected>Artikel Terbaru</option><option value="updated">Artikel Diperbaharui</option></select></td></tr><tr><td><label>Artikel berdasarkan kategori:</label></td><td><span id="labelSorter"><select disabled><option selected>Tunggu sebentar...</option></select></span></td></tr><tr><td><label>Cari artikel:</label></td><td><form id="postSearcher"><input type="text"/></form></td></tr></table></div><header id="resultDesc"></header><ul id="feedContainer"></ul><div id="feedNav">Tunggu sebentar...</div><script type="text/javascript" src="advanced-toc.js"></script>
 */
...
var tocConfig = {
	...
	loading: "<span>Tunggu sebentar...</span>",
